...
import { PayrollReportComponent } from "@/components/reports/payroll/payroll-report";
...
export default async function PayrollReportPage({
  ...
  const report = await reportService.getPayrollReport(from, to);
