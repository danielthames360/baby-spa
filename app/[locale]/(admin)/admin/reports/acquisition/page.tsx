...
import { AcquisitionReport } from "@/components/reports/acquisition/acquisition-report";
import { ArrowLeft } from "lucide-react";
import { Button } from "@/components/ui/button";

interface AcquisitionReportPageProps {
...
export default async function AcquisitionReportPage({
  ...
  // Fetch acquisition report
  const report = await reportService.getAcquisitionReport(from, to);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            {t("reports.acquisition.description")}
          </p>
        </div>
      </div>
      ...
      <DateRangeFilter
        locale={locale}
        basePath="/admin/reports/acquisition"
