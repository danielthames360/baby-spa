...
import { PnLStatement } from "@/components/reports/pnl/pnl-statement";
...
export default async function PnLReportPage({
  ...
  // Fetch P&L report
  const report = await reportService.getPnLReport(from, to);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* P&L Statement */}
      <PnLStatement data={report} locale={locale} />
    </div>
  );
}
