...
import { EventsReportComponent } from "@/components/reports/events/events-report";
import { ArrowLeft } from "lucide-react";
import { Button } from "@/components/ui/button";

interface EventsReportPageProps {
...
export default async function EventsReportPage({
  ...
  // Fetch events report
  const report = await reportService.getEventsReport(from, to);
